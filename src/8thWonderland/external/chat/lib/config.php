...
// Database hostname:
$config['dbConnection']['host'] = 'mysql5-2.300gp';
// Database username:
$config['dbConnection']['user'] = 'thwonderbdd';
// Database password:
$config['dbConnection']['pass'] = 'j5pk8yG6pc7';
// Database name:
$config['dbConnection']['name'] = 'thwonderbdd';
// Database type:
...
$config['styleAvailable'] = array('black');
// Default style:
